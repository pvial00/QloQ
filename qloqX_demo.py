...
from qloqX import encrypt, decrypt, sign, verify, keygen
...
# Alice's keys
alice_sk, alice_pk, alice_mask, alice_mod = keygen()

# Bob's keys
bob_sk, bob_pk, bob_mod, bob_mask = keygen()
...
if verify(from_alice_m, to_bob, bob_pk, bob_mod, bob_mask):
...
if verify(from_bob_m, to_alice, alice_pk, alice_mod, alice_mask):
